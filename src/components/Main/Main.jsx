...
const Main = () => {
    return (
        <div className="App">
            <header id="header" className="header-main ff-mont flex bg"
                    style={{backgroundImage: `url("./img/map-image.png")`}}>
                <div className="container text-center" style={{position: "absolute"}}>
                    <div className="header-content">
                        <h1><i>ІНФОРМАЦІЙНА</i><br/>Система Управління Проектами</h1>
                        <div className="header-form flex">
                            <label htmlFor="header-input"/>
                            <input id="header-input" type="email" placeholder="Введіть електронну пошту" required/>
                            <a id="sign-up" className="btn-main" href="./en/signup.html">Реєстрація</a>
                        </div>
                    </div>
                </div>
                <div className="header-features text-center flex">
                    <div className="header-features-content container flex">
                        <div className="header-features-active">5 200 ІТ
                            <div className="header-features-muted">Проектів</div>
                        </div>
                        <div className="header-features-active">1 000
                            <div className="header-features-muted">Розширень</div>
                        </div>
                        <div className="header-features-active">700 000
                            <div className="header-features-muted">Активних користувачів</div>
                        </div>
                    </div>
                </div>
            </header>
                    ...
                    <div className="features-group text-left">
                        <a className="features-item" href="#">
                            ...
                            <div className="feature-text">
                                <div className="sub-header">Надійність</div>
                                <div className="text-description">Високий коефіцієнт успішних проектів</div>
                            </div>
                        </a>
                        <a className="features-item" href="#">
		...
		C54.224,40.911,57,34.163,57,27C57,12.112,44.888,0,30,0z"/>
                            ...
                            <div className="feature-text">
                                <div className="sub-header">Безпека</div>
                                <div className="text-description">Ми дбаємо про вашу конфіденційність</div>
                            </div>
                        </a>
                        <a className="features-item" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	...
	s-2-0.897-2-2s0.897-2,2-2S47,39.897,47,41z M49,10c-2.206,0-4-1.794-4-4s1.794-4,4-4s4,1.794,4,4S51.206,10,49,10z"/>
                            ...
                            <div className="feature-text">
                                <div className="sub-header">Інтеграція</div>
                                <div className="text-description">API та розширень для розробки проектів</div>
                            </div>
                        </a>
                        <a className="features-item" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
		...
		C31.88,35.996,29.996,36.247,28.188,35.76z"/>
                            ...
                            <div className="feature-text">
                                <div className="sub-header">Конфігурація</div>
                                <div className="text-description">Підтримка 12 шаблонів проектування</div>
                            </div>
                        </a>
                        <a className="features-item" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	...
	c-6.148,0-11.387,4.02-13.099,9.694C3.309,39.642,2,34.972,2,30C2,18.09,9.477,7.9,19.982,3.86z"/>
                            ...
                            <div className="feature-text">
                                <div className="sub-header">24/7 Підтримка</div>
                                <div className="text-description">Супровід користувачів на кожному кроці</div>
                            </div>
                        </a>
                        <a className="features-item" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
		...
		C30.68,6.002,30.655,6,30.63,6c-0.164,0-0.328,0.011-0.492,0.014C30.022,6.017,29.913,6.016,29.793,6.021z"/>
                            ...
                            <div className="feature-text">
                                <div className="sub-header">Ефективність</div>
                                <div className="text-description">Максимальна продуктивність розроблених сервісів</div>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <section className="markets ptb-100 text-center">
                <div className="btn-group">
                    <a href="" className="markets-btn">JS</a>
                    <a href="" className="markets-btn">PY</a>
                    <a href="" className="markets-btn">CS</a>
                </div>
                <table id="markets" className="mx-auto">
                    <thead>
                    <tr>
                        <td>Назва</td>
                        <td>Стабільна версія</td>
                        <td><span className="m-none">Оновлення</span></td>
                        <td className="m-none">Завантажень</td>
                    </tr>
                    </thead>
                    <tfoot>
                    <tr>
                        <td colSpan="100%"><a href="">Більше ></a></td>
                    </tr>
                    </tfoot>
                    <tbody>
                    <tr>
                        <td className="h-align">
                            <img src="./ico/angular.png" alt=""/>
                            <div className="text-left">
                                <span>Angular</span>
                                <span className="m-switch muted">Angular</span>
                            </div>
                        </td>
                        <td>v4.0</td>
                        <td className="buy">v4.4</td>
                        <td className="m-none">25 485</td>
                    </tr>
                    <tr>
                        <td className="h-align">
                            <img src="./ico/react.png" alt=""/>
                            <div className="text-left">
                                <span>React</span>
                                <span className="m-switch muted">React</span>
                            </div>
                        </td>
                        <td>v18.0</td>
                        <td className="buy">v18.04</td>
                        <td className="m-none">25 485</td>
                    </tr>
                    <tr>
                        <td className="h-align">
                            <img src="./ico/travis.png" alt=""/>
                            <div className="text-left">
                                <span>Travis</span>
                                <span className="m-switch muted">Travis</span>
                            </div>
                        </td>
                        <td>v3.0</td>
                        <td className="buy">v3.3</td>
                        <td className="m-none">25 485</td>
                    </tr>
                    <tr>
                        <td className="h-align">
                            <img src="./ico/docker.png" alt=""/>
                            <div className="text-left">
                                <span>Docker</span>
                                <span className="m-switch muted">Docker</span>
                            </div>
                        </td>
                        <td>v2.0</td>
                        <td className="buy">v2.4</td>
                        <td className="m-none">25 485</td>
                    </tr>
                    <tr>
                        <td className="h-align">
                            <img src="./ico/git.png" alt=""/>
                            <div className="text-left">
                                <span>Git</span>
                                <span className="m-switch muted">Git</span>
                            </div>
                        </td>
                        <td>v2.0</td>
                        <td className="buy">v2.2</td>
                        <td className="m-none">25 485</td>
                    </tr>
                    <tr>
                        <td className="h-align">
                            <img src="./ico/django.png" alt=""/>
                            <div className="text-left">
                                <span>Django</span>
                                <span className="m-switch muted">Django</span>
                            </div>
                        </td>
                        <td>v4.0</td>
                        <td className="buy">v4.4</td>
                    ...
                    <tr>
                        <td className="h-align">
                            <img src="./ico/emmet.png" alt=""/>
                            <div className="text-left">
                                <span>Emmet</span>
                                <span className="m-switch muted">Emmet</span>
                            </div>
                        </td>
                        <td>v3.0</td>
                        <td className="buy">v3.3</td>
            ...
            <section className="project bg" style={{backgroundImage: `url("./img/earth.jpg")`}}>
                <div className="project-content container text-center flex">
                    <div className="project-title ff-mont">1 580 970
                        <div className="project-title-sm ff-slab">Користувачів по всьому світу</div>
                    </div>
                </div>
            </section>
            ...
            <footer className="footer-main">
                <div className="container">
                    <div className="start-trading text-center">
                        <h2 className="start-trading-title text-header">Створіть Унікальний Проект</h2>
                        <div className="start-trading-group">
                            <a className="btn btn-outline" href="#">Вхід</a>
                            <a className="btn" href="#">Реєстр.</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container flex">
                        <div className="footer-item">
                            <div className="footer-link">
                                <div className="footer-header">Про нас</div>
                                <a className="drop-links">+</a>
                            </div>
                            <div className="footer-content">
                                <a href="" className="muted">Про нас</a>
                                <a href="" className="muted">Lightning Блог</a>
                                <a href="" className="muted">Спільнота</a>
                                <a href="" className="muted">Компанія</a>
                                <a href="" className="muted">Анонси</a>
                                <a href="" className="muted">Новини</a>
                            </div>
                        </div>
                        <div className="footer-item">
                            <div className="footer-link">
                                <div className="footer-header">Продукти</div>
                                <a className="drop-links">+</a>
                            </div>
                            <div className="footer-content">
                                <a href="" className="muted">Продукти</a>
                                <a href="" className="muted">Сервіси</a>
                                <a href="" className="muted">Лабораторія</a>
                                <a href="" className="muted">ІТ Академія</a>
                                <a href="" className="muted">Відкриті проекти</a>
                                <a href="" className="muted">Дослідження</a>
                                <a href="" className="muted"></a>
                            </div>
                        </div>
                        <div className="footer-item">
                            <div className="footer-link">
                                <div className="footer-header">Послуги</div>
                                <a className="drop-links">+</a>
                            </div>
                            <div className="footer-content">
                                <a href="" className="muted">Послуги</a>
                                <a href="" className="muted">Застосування</a>
                                <a href="" className="muted">Ліцензія</a>
                                <a href="" className="muted">Безпека</a>
                                <a href="" className="muted">Анонси</a>
                                <a href="" className="muted">Новини</a>
                            </div>
                        </div>
                        <div className="footer-item">
                            <div className="footer-link">
                                <div className="footer-header">Підтримка</div>
                                <a className="drop-links">+</a>
                            </div>
                            <div className="footer-content">
                                <a href="" className="muted">Підтримка</a>
                                <a href="" className="muted">Надіслати запит</a>
                                <a href="" className="muted">Часті питання</a>
                                <a href="" className="muted">API документація</a>
                                <a href="" className="muted">Правила використання</a>
                                <a href="" className="muted">Модулі</a>
                            </div>
                        </div>
                        <div className="footer-item">
                            <div className="footer-link">
                                <div className="footer-header">Спільнота</div>
                                <a className="drop-links">+</a>
                            </div>
                            <div className="footer-content">
                                <a href="" className="muted">Telegram</a>
                                <a href="" className="muted">Facebook</a>
                                <a href="" className="muted">Twitter</a>
                                <a href="" className="muted">Reddit</a>
                                <a href="" className="muted">Instagram</a>
                                <a href="" className="muted">YouTube</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="copyright text-center">© 2001 - 2021 Lightning Project</div>
            </footer>
        </div>
    )
}
